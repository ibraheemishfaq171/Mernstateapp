...
const Profile = () => {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_URL}/api/user/update/${
          currentUser._id
        }`,
        {
          method: "POST",
  ...
  const handledeleteUser = async () => {
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_URL}/api/user/delete/${
          currentUser._id
        }`,
        {
          method: "DELETE",
  ...
  const handlesignOut = async () => {
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_URL}/api/auth/signout`
      );
      const data = await res.json();
      if (data.success === false) {
  ...
  const handleShowListings = async () => {
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_URL}/api/user/listings/${
          currentUser._id
        }`
      );
      const data = await res.json();
  ...
  const handleListingDelete = async (id) => {
    try {
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_URL}/api/listing/delete/${id}`,
        {
          method: "DELETE",
        }
      );
